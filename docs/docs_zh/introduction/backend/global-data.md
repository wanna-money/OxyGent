...
[上一章：设置数据库](./database.md)
[下一章：创建简单的多agent系统](../multi-agent/multi-agent-system.md)
[回到首页](../readme.md)
...
- [全局数据示例](../../examples/backend/demo_global_data.md) — 展示如何设置和使用全局数据
- [数据作用域示例](../../examples/backend/demo_data_scope.md) — 展示数据在不同作用域中的行为
