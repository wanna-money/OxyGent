...
[上一章：选择智能体种类](../agents/create-agent.md)
[下一章：使用MCP开源工具](./opensource-mcp-tools.md)
[回到首页](../readme.md)
...
- [FunctionHub工具注册示例](../../examples/tools/demo_functionhub.md) — 演示如何使用FunctionHub注册本地工具
- [单智能体示例](../../examples/agents/demo_single_agent.md) — 演示单个智能体配合工具的基本用法
