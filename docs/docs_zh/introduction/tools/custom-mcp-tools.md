...
- [MCP工具使用示例](../../examples/tools/demo_mcp.md) — 演示MCP工具的基本使用方法
- [MCP带Headers示例](../../examples/tools/demo_mcp_with_headers.md) — 演示如何为MCP工具配置自定义请求头
- [火车票MCP示例](../../examples/mcp_tools/demo_train_ticket.md) — 一个完整的自定义MCP工具应用示例
