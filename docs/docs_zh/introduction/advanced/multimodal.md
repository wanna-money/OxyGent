...
[上一章：获取记忆和重新生成](./continue-exec.md)
...
- [多模态示例](../../examples/advanced/demo_multimodal.md) — 展示如何配置和使用多模态输入进行图像处理
- [多模态传输示例](../../examples/advanced/demo_multimodal_transfer.md) — 展示如何在智能体之间传递多模态数据
