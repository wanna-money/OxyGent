...
[上一章：检索增强生成(RAG)](./rag.md)
[下一章：可视化界面调试](../backend/debugging.md)
[回到首页](../readme.md)
...
- [GRPO重采样示例](../../examples/advanced/demo_grpo_resample.md) — 展示如何使用GRPO进行多智能体联合训练采样
- [评估与进化示例](../../examples/agents/demo_evaluate_and_evolve.md) — 展示如何评估智能体表现并自动进化优化
