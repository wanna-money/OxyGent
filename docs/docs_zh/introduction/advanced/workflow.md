...
Workflow是一种非常精细的方法，下面将以[如何自定义处理提示词？](./process-input.md)中的例子入手，逐步写一个可以运行的workflow。
...
[上一章：反思重做模式](./reflexion.md)
[下一章：创建流](./preset-flows.md)
[回到首页](../readme.md)
...
- [工作流智能体示例](../../examples/agents/demo_workflow_agent.md) — 展示如何使用WorkflowAgent构建自定义工作流
