...
[上一章：复制相同智能体](./mixture-of-agents.md)
...
- [并行智能体示例](../../examples/agents/demo_parallel.md) — 演示ParallelAgent的并行执行用法
- [文档分析智能体示例](../../examples/agents/demo_document_analysis_agent.md) — 演示并行处理文档的实际应用
