...
[下一章：注册本地工具](../tools/register-tool.md)
[回到首页](../readme.md)
...
- [Live Prompts 示例](../../examples/live_prompts/demo_live_prompt.md) — 动态提示词的完整使用示例
- [Live Prompts Demo](../../examples/live_prompts/demo.md) — 动态提示词快速入门
- [Config 设置示例](../../examples/backend/demo_config.md) — 配置管理示例
