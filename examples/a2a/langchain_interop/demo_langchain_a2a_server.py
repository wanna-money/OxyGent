"""Minimal LangChain-based A2A server demo.
...
chain = RunnableLambda(lambda x: f"[LangChain Server] {x}")
...
async def card():
    return {
        "name": "langchain_a2a_server",
        "description": "LangChain powered A2A demo server",
        "version": "0.1.0",
        ...
        "skills": [
            {
                "id": "chat",
                "name": "chat",
                "description": "Chat with LangChain demo server",
                "tags": ["langchain", "a2a", "chat"],
